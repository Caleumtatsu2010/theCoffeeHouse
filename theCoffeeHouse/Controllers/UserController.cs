...
namespace theCoffeeHouse.Controllers
{
    public class UserController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            //check xem tai khoan co profile chua
            var exsits = k.GetBytenDangNhap(Session["UserName"].ToString());
            
            if (exsits != null)// tai khoan nay da co profile => load profile
            {
                DateTime datevalue = Convert.ToDateTime(exsits.ngaySinh.ToString());
                ...
                {
                    d = datevalue.Day.ToString();
                }
                string ngay = y + "-" + m + "-" + d;

                ViewBag.Ngaysinh = ngay;
                ViewBag.Profile = exsits;
                ViewBag.Anh = exsits.hinhAnh;
                //2017 - 06 - 01
            }
            return View();
